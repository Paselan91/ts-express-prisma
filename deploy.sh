...
# ECR_ENDPOINT=<your-account-id>.dkr.ecr.ap-northeast-1.amazonaws.com/fms-dev-repository ECS_CLUSTER_NAME=my-cluster ECS_SERVICE_NAME=my-service IMAGE_NAME=latest ./deploy.sh
